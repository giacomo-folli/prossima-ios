...
export const METRIC_DETAILS: Record<string, MetricConfig> = {
	readiness: {
		...
		color: "#00E5FF",
		explanation:
			"Readiness is a daily metric from 0 to 100 that tells you how prepared your body is for physical and mental strain.\n\nIt is calculated by evaluating four key pillars - HRV, Sleep, Resting HR, and Training Load - and assigning each a normalized score out of 100.\n\nThese individual pillar scores are then weighted and combined (HRV 35%, Sleep 25%, RHR 20%, Load 20%) to form your final score.",
		whyItMatters:
			"This composite approach helps prevent overtraining and accurately guides you on when to push hard or prioritize rest.",
	...
	hrv: {
		...
		explanation:
			"HRV measures the variation in time between consecutive heartbeats in milliseconds (ms). It is regulated by the autonomic nervous system.",
		whyItMatters:
			"A higher HRV indicates your nervous system is balanced and ready to adapt to stressors. A drop in HRV is a strong indicator of fatigue, stress, or upcoming illness.",
	...
	restingHr: {
		...
		explanation:
			"Your resting heart rate is the number of times your heart beats per minute (bpm) when you are completely at rest.",
		whyItMatters:
			"A lower RHR indicates efficient heart function and cardiorespiratory fitness. An elevated resting HR can indicate fatigue, overreaching, or a lack of recovery.",
	...
	sleep: {
		...
		explanation:
			"Sleep duration tracks the total hours you spent asleep last night.",
		whyItMatters:
			"Sleep is the cornerstone of physical recovery, hormone regulation, and cognitive function. Chronic sleep deficit hinders muscle repair and immune system health.",
	...
	weight: {
		...
		explanation:
			"Body weight is the measurement of your total body mass in kilograms.",
		whyItMatters:
			"Tracking weight helps monitor energy balance and hydration status. It is crucial for strength-to-weight ratio sports and general body composition tracking.",
	...
	vo2max: {
		...
		whyItMatters:
			"It is the gold standard indicator of cardiovascular fitness and aerobic endurance. Improving your VO2 Max enhances overall health and longevity.",
	...
	vitals: {
		...
		explanation:
			"Vitals track blood oxygen saturation (SpO2) and sleeping respiratory rate.",
		whyItMatters:
			"SpO2 measures the percentage of oxygen in your blood (normal: 95-100%). Sleeping respiratory rate tracks breaths per minute. Shifts can signal illness, low oxygen environments, or high physiological stress.",
	...
	steps: {
		...
		whyItMatters:
			"Steps are an excellent measure of non-exercise activity thermogenesis (NEAT) and help prevent sedentary lifestyle diseases.",
	...
	workouts: {
		...
		explanation:
			"Workouts tracks the total number of structured exercise sessions logged.",
		whyItMatters:
			"Consistency in training frequency is key to long-term cardiovascular and muscular adaptation.",
	...
	calories: {
		...
		explanation:
			"Active Energy is the active calories burned through exercise, workouts, and general daily movement.",
		whyItMatters:
			"Helps you monitor your energy output, manage body weight goals, and properly fuel your recovery.",
	...
	duration: {
		...
		whyItMatters:
			"Tracks training volume and time under tension, ensuring your training sessions are of adequate duration to trigger metabolic adaptation.",
