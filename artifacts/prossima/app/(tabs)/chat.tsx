...
const THINKING_STEPS: ThinkingStep[] = [
  { id: "1", text: "Analyzing your recent recovery signals", icon: "search", done: false },
  { id: "2", text: "Reviewing sleep, effort, and biomarker trends", icon: "analytics", done: false },
  { id: "3", text: "Preparing insights and recommendations", icon: "sparkles", done: false },
];
            ...
            >
              ...
              >
                <View style={styles.thinkingHeaderLeft}>
                  <Animated.View
                    style={[styles.thinkingDot, { opacity: pulseOpacity, backgroundColor: colors.accent }]}
                  />
                  <Text
                    style={[
